...
const DisplayListedBooks = ({book}) => {
    ...
    return (
        <div className='border-2 border-base-200 rounded-2xl p-6 mt-6 mx-auto'>
            <div className='flex flex-col lg:flex-row gap-12 mt-13 mb-14 '>
                ...
                <div className='md:w-3/4'>
                    ...
                    {/* tags */}
                    <div className='flex flex-col md:flex-row gap-3 mt-6 mb-4 md:items-center'>
                        ...
                        <p className='flex gap-2 md:justify-center md:items-center'><CiLocationOn /> Year of Publishing: {yearOfPublishing}</p>
                    </div>
                
                    <div className='mt-3 flex flex-col md:flex-row gap-8'>
                    ...
                    <div className='flex flex-col md:flex-row gap-3 '>
                        ...
                        <Link to={`/book/${book.bookId}`} className='bg-[#23BE0A] text-white py-1.75 px-4 work-sans-font rounded-[30px] text-center text-[16px]'>View Details</Link>
